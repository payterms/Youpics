...
public class GlideLoader {
    ...
    private PicsCache picsCache;

    public GlideLoader(PicsCache picsCache) {
        this.picsCache = picsCache;
    }
        ...
        Glide
                ...
                .into(new CustomTarget<Bitmap>() {
                    ...
                    public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                        ...
                        picsCache.saveImage2FS(resource, hit);
                    }
                    @Override
    ...
    public void loadImageFromStorage(ImageView imageView, Hit hit) {
        File imagePath = picsCache.getImagePath(hit);
        Glide
                .with(imageView.getContext())
                .load(imagePath)
                .into(imageView);
